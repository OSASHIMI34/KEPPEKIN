...
Shader "RealToon/Version 5/Lite/Default" {
    Properties {
        ...
        [Toggle] _CustomLightDirectionFollowObjectRotation ("Custom Light Direction Follow Object Rotation", Float ) = 0
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v)
			{
                ...
                VertexOutput o = (VertexOutput)0;
					...
					half RTL_OL_VCRAOW_OO = lerp( _OutlineWidth, (_OutlineWidth*(1.0 - o.vertexColor.r)), _VertexColorRedAffectOutlineWitdh );
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR 
			{
                ...
                float attenuation = LIGHT_ATTENUATION(i);
					...
					half RTL_SON_VCBCSON_OO = lerp( _SmoothObjectNormal, (_SmoothObjectNormal*(1.0 - i.vertexColor.b)), _VertexColorBlueControlSmoothObjectNormal );
				...
				half3 RTL_FR_OFF_OTHERS = (lerp( RTL_TEX_COL , _MainTex_var.rgb , _MCIALO) * lerp((((_SelfShadowRealTimeShadowColor.rgb*_SelfShadowRealTimeShadowColorPower)*RTL_OSC*RTL_SCT*RTL_PT)*RTL_LVLC),(RTL_RL_CHE_1*RTL_ST*RTL_SON_CHE_1*lightColor.rgb),RTL_SS));
					...
					half3 RTL_FR_SEL = lerp(RTL_FR,lerp(RTL_FR,RTL_TEX_COL,_MaskSelfLit_var.r),_SelfLitIntensity);
