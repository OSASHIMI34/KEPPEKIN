...
Shader "RealToon/Version 5/Default/Default" {
    Properties {
        ...
        [Toggle] _EnableTextureTransparent ("Enable Texture Transparent", Float ) = 0
		...
		[Toggle] _AlphaBaseCutout ("Alpha Base Cutout", Float ) = 1
        [Toggle] _UseSecondaryCutout ("Use Secondary Cutout", Float ) = 0
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR 
			{
                ...
                float3 halfDirection = normalize(viewDirection+lightDirection);
					...
					half RTD_SON_VCBCSON_OO = lerp( _SmoothObjectNormal, (_SmoothObjectNormal*(1.0 - i.vertexColor.b)), _VertexColorBlueControlSmoothObjectNormal );
